...
//    }
    ...
    public void user_navigates_to_register_account_page() {
        ...
        if(regpage.isRegisterAccountPageDiplayed()){
            logger.info("dregister account page displaye");
            Assert.assertTrue(true);}
        else{

        logger.info("dregister account page not displayed");
            Assert.assertTrue(false);}
    ...
    public void user_should_see_message(String expmsg) {
        ...
        {
            logger.info("Account Registration Failled");
            Assert.assertTrue(false);
    }
